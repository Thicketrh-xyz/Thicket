...
///   REWARDS_POOL         reserved mining pool    (default   350,000,000 THKT)
...
contract Deploy is Script {
    function run() external {
        ...
        uint256 rewardsPool = vm.envOr("REWARDS_POOL", uint256(350_000_000 ether));
        ...
        // Fund the rewards pool from the treasury's reserved allocation.
